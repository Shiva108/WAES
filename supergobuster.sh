...
# gobuster -u $URL -l -s 200,204,301,302,307,403 -w SecLists/Discovery/Web_Content/sharepoint.txt
gobuster -u $URL -l -s 200,204,301,302,307,403 -w SecLists/Discovery/Web-Content/iis.txt
